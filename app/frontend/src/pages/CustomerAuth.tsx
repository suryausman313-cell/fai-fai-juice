...
export default function CustomerAuth() {
  ...
  // Review-safe mode: keep the existing Google implementation in the file,
  // but do not expose a Google button on Web, Android, or iOS until native
  // Google sign-in is fully configured and tested.
